...
def main(config, case_config):
    ...
    print("Test Correctness with op1-times smaller operation"
    ...
    a = torch.randn(Melements * 111 * 111, dtype=dtype[config.dataformat]).to(0)
    ...
    print_result(config, "op1", *perf_result, mape, mape_std,

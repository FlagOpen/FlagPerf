...
class XlaTrainer:
    def __init__(
        ...
        # PrecisionDebuggerINIT('/login_home/zhangxiaohe/transformers/config_tensor.json',model=self.model)
    ...
    def training_step(self, model: nn.Module, inputs: Dict[str, Union[torch.Tensor, Any]]) -> torch.Tensor:
        ...
        # inputs= self._convert_to_float32(inputs)
        ...
        **kwargs,
        ...
        for epoch in range(0, 1):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                # PrecisionDebuggerBGN() #开启中间数据dump
                ...
                print(f"!!!!!!!!!do step : {step}, tr_loss_step:{tr_loss_step},learning_rate:{learning_rate}")
                break

...
def parse_args():
    ...
    parser.add_argument("--ddp_dp_sharding", type=int, default=-1, help="FSDP dp number..")
...
def main():
    ...
    sys.argv = [args.training_script] + args.training_script_args + \
        ["--ddp_dp_sharding", str(args.ddp_dp_sharding), "--megatron_tp_sharding", str(args.megatron_tp_sharding)]

    device_preprocess = functools.partial(mod._mp_device_preprocess, ddp_dp_sharding=args.ddp_dp_sharding, megatron_tp_sharding=args.megatron_tp_sharding)

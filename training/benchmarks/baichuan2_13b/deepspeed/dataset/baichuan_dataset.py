...
class BaichuanPretrainDataset(Dataset):
...
def get_baichuan_dataset(args, seqlength, datafilename):
    dataset = BaichuanPretrainDataset(os.path.join(args.data_dir, datafilename),
                                    seqlength)
    return dataset

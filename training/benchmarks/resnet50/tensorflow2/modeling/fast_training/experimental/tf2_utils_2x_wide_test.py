...
from .modeling.fast_training.experimental import tf2_utils_2x_wide
...
class Tf2Utils2XWideTest(tf.test.TestCase):
    ...
    def test_end_to_end(self):
        ...
        tf2_utils_2x_wide.model_to_model_2x_wide(model_narrow,
                                                 model_wide,
                                                 epsilon=0.2)

        self.assertAllClose(model_narrow(x0),
                            model_wide(x1),
                            rtol=1e-05,
                            atol=1e-05)

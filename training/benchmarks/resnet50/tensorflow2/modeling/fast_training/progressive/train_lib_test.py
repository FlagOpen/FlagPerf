...
from .modeling.fast_training.progressive import train_lib
from .modeling.fast_training.progressive import trainer as prog_trainer_lib
...
class ProgMockTask(policies.ProgressivePolicy, mock_task.MockTask):
    ...
    def __init__(self, params: cfg.TaskConfig, logging_dir: str = None):
        mock_task.MockTask.__init__(self,
                                    params=params,
    ...
    def get_train_dataset(self, stage_id):
        ...
        return orbit.utils.make_distributed_dataset(strategy,

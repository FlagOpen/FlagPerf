...
from .modeling.fast_training.progressive import trainer as trainer_lib
from .nlp.configs import bert
...
class TestPolicy(policies.ProgressivePolicy, mock_task.MockTask):
    ...
    def get_model(self, stage_id: int,
    ...
    def get_train_dataset(self, stage_id: int) -> tf.data.Dataset:
        ...
        if self._strategy:
            self._my_train_dataset = orbit.utils.make_distributed_dataset(
                self._strategy, self._build_inputs, stage_id)
        else:
...
class TrainerTest(tf.test.TestCase, parameterized.TestCase):
    ...
    def create_test_trainer(self, distribution, model_dir,

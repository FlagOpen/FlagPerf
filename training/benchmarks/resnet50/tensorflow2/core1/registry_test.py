...
class RegistryTest(tf.test.TestCase):
    ...
    def test_register(self):
        ...
        self.assertEqual(registry.lookup(collection, 'functions/func_0'),
                         func_test)
        ...
        self.assertEqual(registry.lookup(collection, 'classes/cls_0'),
                         ClassRegistryKey)
        ...
        self.assertEqual(registry.lookup(collection, ClassRegistryKey),
                         ClassRegistryValue)

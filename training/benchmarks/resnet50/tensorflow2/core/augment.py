...
def wrapped_rotate(image: tf.Tensor, degrees: float,
            ...
            def make_final_policy(tf_policy_):
                ...
                def final_policy(image_):
                    for func, prob, args in tf_policy_:
                        image_ = _apply_func_with_prob(func, image_, args,
                                                       prob)
                    return image_

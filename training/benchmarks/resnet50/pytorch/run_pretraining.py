...
def main() -> Tuple[Any, Any]:
    ...
    # eval_dataloader = build_eval_dataloaders(config, val_dataset, worker_init)
    ...
    # read best_acc1 from checkpoint
    ...
    #         checkpoint = torch.load(config.init_checkpoint, map_location=loc)

...
parser.add_argument("--openwebtext_dir", type=str, default="/data/llama2_7b_pretrain/openwebtext")
parser.add_argument("--output_file", type=str, default="/data/llama2_7b_pretrain/openwebtext_llama2_100M.npy")

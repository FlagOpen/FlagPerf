...
from dataloaders.datasets import SyntheticDataset, ParametricDataset
from dataloaders.defaults import TEST_MAPPING, TRAIN_MAPPING
from dataloaders.feature_spec import FeatureSpec
from dataloaders.samplers import RandomDistributedSampler
from dataloaders.utils import collate_split_tensors
...
class ParametricDatasetFactory(DatasetFactory):
    ...
    def __init__(self, flags, feature_spec: FeatureSpec, numerical_features_enabled, categorical_features_to_read):
        ...
        self._train_batch_size = flags.train_batch_size
        self._test_batch_size = flags.eval_batch_size

...
from model.layers.transformer_block import GLMTransformerLayer
...
if __name__ == "__main__":
    ...
    seq_len = 512
    hidden_size = 1024
    hidden_states = torch.rand([batch_size, seq_len,hidden_size], dtype=torch.float32).to("cuda")
    position_ids = torch.ones([batch_size, 2, seq_len], dtype=torch.int64).to('cuda')

...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):    
        ...
        input_ids, segment_ids, input_mask, masked_lm_labels, next_sentence_labels = self.data_list[index]
...
class PretrainingDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        masked_token_count = np.sum(np.ones(masked_token_idx.shape, dtype='int32'))

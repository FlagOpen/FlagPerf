...
def call_llava_engine_df(sample, model, tokenizer=None, processor=None):
    from config.constants import IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN

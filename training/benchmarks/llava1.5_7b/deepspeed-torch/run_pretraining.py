...
if __name__ == "__main__":
    ...
    mmmu_output_path = os.path.join(script_dir, "config/llava1.5_7b.json")
    ...
    print("MFU: ", chip_tps_finetune * 7000000000.0 * 6 / theoryflops)

    total_time = pretrain_time + finetune_time
    mfu_average = (tokens_pretrain * 558128 * 7000000000.0 * 2 +
                    tokens_finetune * 665344 * 7000000000.0 *

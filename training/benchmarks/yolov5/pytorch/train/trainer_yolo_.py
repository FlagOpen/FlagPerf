...
from dataloaders.dataloader import build_eval_dataloader,build_eval_dataloader
...
class Trainer:
    ...
    def train_one_epoch_(self,train_dataloader,dataset):
        opt = parse_opt()
        ...
        train_dataloader,dataset = build_train_dataloader(opt)
        
        if RANK in {-1.0}:
            val_dataloader = build_eval_dataloader(opt)
        ...
        stopper, stop = EarlyStopping(patience=config.patience), False
    ...
    def train_one_step_(self, batch):

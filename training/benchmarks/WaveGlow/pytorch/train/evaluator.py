...
class Evaluator(object):
    ...
    @torch.no_grad()
    def validate(self, model, criterion, epoch, batch_iter,
             world_size, distributed_run, batch_to_gpu, amp_run, val_loader):
        ...
        with evaluating(model), torch.no_grad():
            ...
            for i, batch in enumerate(val_loader):
                ...
                self.logger.log(step=(epoch, batch_iter, i), data={'val_items_per_sec': items_per_sec})
            ...
            self.logger.log(step=(epoch,), data={'val_items_per_sec': val_items_per_sec})

...
if __name__ == "__main__":
    ...
    exec_cmd = exec_cmd + "patch --silent --forward " + origin_file + " < tokenizer.patch;"

    # bash megatron_main.sh
    
    exec_cmd = exec_cmd + "bash megatron_main.sh"
    ...
    print("MFU: ", chip_tps * 12700000000.0 * 6 / theoryflops)
...
def main():
    ...
    npu_cmd = "date;npu-smi info | awk 'NR > 2 && NR < 31 {print}';echo \"\""
    npu_file = open(log_dir + "npu.log.txt", "w")
    npu_thread = threading.Thread(target=run_cmd, args=(npu_cmd, 5, npu_file))

...
# 1000 steps * SEQLENGTH (4096) * GLOBAL_BATCHSIZE (5632) = 23068672000
TRAINING_TOKENS = 23068672000
...
# network
# =========================================================
net_cmd ="export HCCL_CONNECT_TIMEOUT=3600;export HCCL_EXEC_TIMEOUT=0;export GLOO_SOCKET_IFNAME=bond0;export HCCL_SOCKET_IFNAME=bond0;export CUDA_DEVICE_MAX_CONNECTIONS=1;ulimit -n 409600"
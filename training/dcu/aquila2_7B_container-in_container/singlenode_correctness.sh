...
SCALEHOME=/home/yingz/FlagCode0118/FlagScale-release-v0.2

LOAD_CKPT_PATH=/data/flagperf/load_aiplat
TB_PATH=/FlagTest/FlagPerf-AI_platform/training/result-7B/tb/aquila7B-28
mkdir -p $TB_PATH

DATADIR=/flagperf/wudao_pretrain

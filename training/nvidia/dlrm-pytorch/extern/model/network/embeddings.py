...
from cuda_ext.fused_gather_embedding import BuckleEmbeddingFusedGatherFunction
from cuda_ext.sparse_embedding import JointSparseEmbedding as JointSparseEmbedding2
...
class JointSparseEmbedding(Embeddings):
    ...
    def __init__(
        ...
        self.embedding = JointSparseEmbedding2(categorical_feature_sizes, embedding_dim, device)
        self.hash_indices = hash_indices

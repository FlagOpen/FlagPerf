...
from .embeddings import (JointEmbedding, MultiTableEmbeddings,
                         FusedJointEmbedding, JointSparseEmbedding, Embeddings)
from .interactions import Interaction, CudaDotInteraction, DotInteraction, CatInteraction
from .mlps import AbstractMlp, CppMlp, TorchMlp
from utils.distributed import is_distributed


def create_mlp(input_dim: int, sizes: Sequence[int],
               use_cpp_mlp: bool) -> AbstractMlp:
    return CppMlp(input_dim, sizes) if use_cpp_mlp else TorchMlp(
        input_dim, sizes)
...
def create_interaction(interaction_op: str, embedding_num: int,
                       embedding_dim: int) -> Interaction:

...
def main():
    ...
    cmd = cmd + r"export PATH=/usr/local/corex/bin:$PATH; export LD_LIBRARY_PATH=/usr/local/corex/lib; ixsmi | grep 'Driver Version' | awk '{print $3}';"
    cmd = cmd + r"echo ;"
    ...
    gpu_cmd = "date;export PATH=/usr/local/corex/bin:$PATH; export LD_LIBRARY_PATH=/usr/local/corex/lib; ixsmi |grep 'Default'|awk '{print $3,$5,$9,$11,$13}';echo \"\""

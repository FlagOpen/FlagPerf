...
#define BATCHES_PER_WARP_SMALLER_THAN_128 1
#else
#define BATCHES_PER_WARP_SMALLER_THAN_128 2
#endif

// make sure that WARP_ITER_N * C10_WARP_SIZE is equal in different platform
#if defined(__ILUVATAR__)
#define WARP_ITER_1 1
#define WARP_ITER_2 2
#define WARP_ITER_3 4
#define WARP_ITER_4 8
#define WARP_ITER_5 16
#define WARP_ITER_6 32
#else
#define WARP_ITER_1 2
#define WARP_ITER_2 4
#define WARP_ITER_3 8
#define WARP_ITER_4 16
#define WARP_ITER_5 32
#define WARP_ITER_6 64
#endif
...
bool warp_softmax_kernel(int log2_elements, int &warp_size, int &batches_per_warp, softmax_forward_func<input_t, output_t> &kernel) {
    ...
    case 0: // 1
        kernel = &softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,1,1>;
        break;
    case 1: // 2
        kernel = &softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,2,1>;
        break;
    case 2: // 4
        kernel = &softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,4,1>;
        break;
    case 3: // 8
        kernel = &softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,8,1>;
        break;
    case 4: // 16
        kernel = &softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,16,1>;
        break;
    case 5: // 32
        kernel = &softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,32,1>;
        break;
    case 6: // 64
        kernel = &softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_1,C10_WARP_SIZE,1>;
        break;
    case 7: // 128
        kernel = &softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_2,C10_WARP_SIZE,1>;
        break;
    case 8: // 256
        kernel = &softmax_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_3,C10_WARP_SIZE,1>;
        break;
    case 9: // 512
        kernel = &softmax_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_4,C10_WARP_SIZE,1>;
        break;
    case 10: // 1024
        kernel = &softmax_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_5,C10_WARP_SIZE,1>;
        break;
    default:
        return false;
    }
...
#else
        // use 64 threads per block to maximimize gpu utilization
...
#else
    batches_per_warp = 1;
    bool flag_vec4 = false;
#endif
    switch (log2_elements) {
    case 0: // 1
        kernel = &additive_masked_softmax_dropout_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,1,1>;
        break;
    case 1: // 2
        kernel = &additive_masked_softmax_dropout_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,2,1>;
        break;
    case 2: // 4
        kernel = &additive_masked_softmax_dropout_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,4,1>;
        break;
    case 3: // 8
        kernel = &additive_masked_softmax_dropout_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,8,1>;
        break;
    case 4: // 16
        kernel = &additive_masked_softmax_dropout_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,16,1>;
        break;
    case 5: // 32
        kernel = &additive_masked_softmax_dropout_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,32,1>;
        break;
    case 6: // 64
        kernel = &additive_masked_softmax_dropout_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_1,C10_WARP_SIZE,1>;
        break;
    case 7: // 128
	if (flag_vec4) kernel = &additive_masked_softmax_dropout_warp_forward_vec4<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_2,C10_WARP_SIZE,4>;
	else kernel = &additive_masked_softmax_dropout_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_2,C10_WARP_SIZE,1>;
        break;
    case 8: // 256
	if (flag_vec4) kernel = &additive_masked_softmax_dropout_warp_forward_vec4<input_t, output_t, acc_t, 1,WARP_ITER_3,C10_WARP_SIZE,4>;
	else kernel = &additive_masked_softmax_dropout_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_3,C10_WARP_SIZE,1>;
        break;
    case 9: // 512
        if (flag_vec4) kernel = &additive_masked_softmax_dropout_warp_forward_vec4<input_t, output_t, acc_t, 1,WARP_ITER_4,C10_WARP_SIZE,4>;
	else kernel = &additive_masked_softmax_dropout_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_4,C10_WARP_SIZE,1>;
        break;
    case 10: // 1024
        if (flag_vec4) kernel = &additive_masked_softmax_dropout_warp_forward_vec4<input_t, output_t, acc_t, 1,WARP_ITER_5,C10_WARP_SIZE,4>;
	else kernel = &additive_masked_softmax_dropout_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_5,C10_WARP_SIZE,1>;
        break;
    case 11: // 2048
        if (flag_vec4) kernel = &additive_masked_softmax_dropout_warp_forward_vec4<input_t, output_t, acc_t, 1,WARP_ITER_6,C10_WARP_SIZE,4>;
	else kernel = &additive_masked_softmax_dropout_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_6,C10_WARP_SIZE,1>;
        break;
    default:
        return false;
    }
...
bool warp_additive_masked_softmax_kernel(int log2_elements, int &warp_size, int &batches_per_warp, additive_masked_softmax_forward_func<input_t, output_t> &kernel) {
    ...
    switch (log2_elements) {
    case 0: // 1
        kernel = &additive_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,1,1>;
        break;
    case 1: // 2
        kernel = &additive_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,2,1>;
        break;
    case 2: // 4
        kernel = &additive_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,4,1>;
        break;
    case 3: // 8
        kernel = &additive_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,8,1>;
        break;
    case 4: // 16
        kernel = &additive_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,16,1>;
        break;
    case 5: // 32
        kernel = &additive_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,32,1>;
        break;
    case 6: // 64
        kernel = &additive_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_1,C10_WARP_SIZE,1>;
        break;
    case 7: // 128
        kernel = &additive_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_2,C10_WARP_SIZE,1>;
        break;
    case 8: // 256
        kernel = &additive_masked_softmax_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_3,C10_WARP_SIZE,1>;
        break;
    case 9: // 512
        kernel = &additive_masked_softmax_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_4,C10_WARP_SIZE,1>;
        break;
    case 10: // 1024
        kernel = &additive_masked_softmax_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_5,C10_WARP_SIZE,1>;
        break;
    default:
        return false;
    }
...
bool warp_masked_softmax_kernel(int log2_elements, int &warp_size, int &batches_per_warp, masked_softmax_forward_func<input_t, output_t> &kernel) {
    ...
    switch (log2_elements) {
    case 0: // 1
        kernel = &masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,1,1>;
        break;
    case 1: // 2
        kernel = &masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,2,1>;
        break;
    case 2: // 4
        kernel = &masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,4,1>;
        break;
    case 3: // 8
        kernel = &masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,8,1>;
        break;
    case 4: // 16
        kernel = &masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,16,1>;
        break;
    case 5: // 32
        kernel = &masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,32,1>;
        break;
    case 6: // 64
        kernel = &masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_1,C10_WARP_SIZE,1>;
        break;
    case 7: // 128
        kernel = &masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_2,C10_WARP_SIZE,1>;
        break;
    case 8: // 256
        kernel = &masked_softmax_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_3,C10_WARP_SIZE,1>;
        break;
    case 9: // 512
        kernel = &masked_softmax_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_4,C10_WARP_SIZE,1>;
        break;
    case 10: // 1024
        kernel = &masked_softmax_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_5,C10_WARP_SIZE,1>;
        break;
    default:
        return false;
    }
...
bool warp_time_masked_softmax_kernel(int log2_elements, int &warp_size, int &batches_per_warp, time_masked_softmax_forward_func<input_t, output_t> &kernel) {
    ...
    switch (log2_elements) {
    case 0: // 1
        kernel = &time_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,1,1>;
        break;
    case 1: // 2
        kernel = &time_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,2,1>;
        break;
    case 2: // 4
        kernel = &time_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,4,1>;
        break;
    case 3: // 8
        kernel = &time_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,8,1>;
        break;
    case 4: // 16
        kernel = &time_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,16,1>;
        break;
    case 5: // 32
        kernel = &time_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,32,1>;
        break;
    case 6: // 64
        kernel = &time_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_1,C10_WARP_SIZE,1>;
        break;
    case 7: // 128
        kernel = &time_masked_softmax_warp_forward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_2,C10_WARP_SIZE,1>;
        break;
    case 8: // 256
        kernel = &time_masked_softmax_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_3,C10_WARP_SIZE,1>;
        break;
    case 9: // 512
        kernel = &time_masked_softmax_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_4,C10_WARP_SIZE,1>;
        break;
    case 10: // 1024
        kernel = &time_masked_softmax_warp_forward<input_t, output_t, acc_t, 1,WARP_ITER_5,C10_WARP_SIZE,1>;
        break;
    default:
        return false;
    }
...
bool masked_scale_softmax_warp_backward_recompute_kernel(int element_count, int log2_elements, int &warp_size, int &batches_per_warp, masked_scale_softmax_warp_backward_recompute_func<input_t, output_t, acc_t, is_log_softmax> &kernel) {
    ...
    switch (log2_elements) {
    case 0: // 1
        kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,1,1, is_log_softmax>;
        break;
    case 1: // 2
        kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,2,1, is_log_softmax>;
        break;
    case 2: // 4
        kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,4,1, is_log_softmax>;
        break;
    case 3: // 8
        kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,8,1, is_log_softmax>;
        break;
    case 4: // 16
        kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,16,1, is_log_softmax>;
        break;
    case 5: // 32
        kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,32,1, is_log_softmax>;
        break;
    case 6: // 64
        kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_1,C10_WARP_SIZE,1, is_log_softmax>;
        break;
    case 7: // 128
        kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_2,C10_WARP_SIZE,1, is_log_softmax>;
        break;
    case 8: // 256
	if (flag_vec4) kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, 1,WARP_ITER_3,C10_WARP_SIZE,4, is_log_softmax>;
	else kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, 1,WARP_ITER_3,C10_WARP_SIZE,1, is_log_softmax>;
        break;
    case 9: // 512
        if (flag_vec4) kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, 1,WARP_ITER_4,C10_WARP_SIZE,4, is_log_softmax>;
	else kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, 1,WARP_ITER_4,C10_WARP_SIZE,1, is_log_softmax>;
        break;
    case 10: // 1024
        if (flag_vec4) kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, 1,WARP_ITER_5,C10_WARP_SIZE,4, is_log_softmax>;
	else kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, 1,WARP_ITER_5,C10_WARP_SIZE,1, is_log_softmax>;
        break;
    case 11: // 2048
        if (flag_vec4) kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, 1,WARP_ITER_6,C10_WARP_SIZE,4, is_log_softmax>;
	else kernel = &masked_scale_softmax_warp_backward_recompute<input_t, output_t, acc_t, 1,WARP_ITER_6,C10_WARP_SIZE,1, is_log_softmax>;
        break;
    default:
        return false;
    }
...
bool warp_softmax_backward_kernel(int log2_elements, int &warp_size, int &batches_per_warp, softmax_backward_func<input_t, output_t> &kernel) {
    ...
    switch (log2_elements) {
    case 0: // 1
        kernel = &softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,1,1>;
        break;
    case 1: // 2
        kernel = &softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,2,1>;
        break;
    case 2: // 4
        kernel = &softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,4,1>;
        break;
    case 3: // 8
        kernel = &softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,8,1>;
        break;
    case 4: // 16
        kernel = &softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,16,1>;
        break;
    case 5: // 32
        kernel = &softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,32,1>;
        break;
    case 6: // 64
        kernel = &softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_1,C10_WARP_SIZE,1>;
        break;
    case 7: // 128
        kernel = &softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_2,C10_WARP_SIZE,1>;
        break;
    case 8: // 256
        kernel = &softmax_warp_backward<input_t, output_t, acc_t, 1,WARP_ITER_3,C10_WARP_SIZE,1>;
        break;
    case 9: // 512
        kernel = &softmax_warp_backward<input_t, output_t, acc_t, 1,WARP_ITER_4,C10_WARP_SIZE,1>;
        break;
    case 10: // 1024
        kernel = &softmax_warp_backward<input_t, output_t, acc_t, 1,WARP_ITER_5,C10_WARP_SIZE,1>;
        break;
    default:
        return false;
    }
...
bool warp_masked_softmax_backward_kernel(int log2_elements, int &warp_size, int &batches_per_warp, masked_softmax_backward_func<input_t, output_t> &kernel) {
    ...
    switch (log2_elements) {
    case 0: // 1
        kernel = &masked_softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,1,1>;
        break;
    case 1: // 2
        kernel = &masked_softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,2,1>;
        break;
    case 2: // 4
        kernel = &masked_softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,4,1>;
        break;
    case 3: // 8
        kernel = &masked_softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,8,1>;
        break;
    case 4: // 16
        kernel = &masked_softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,16,1>;
        break;
    case 5: // 32
        kernel = &masked_softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, 1,32,1>;
        break;
    case 6: // 64
        kernel = &masked_softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_1,C10_WARP_SIZE,1>;
        break;
    case 7: // 128
        kernel = &masked_softmax_warp_backward<input_t, output_t, acc_t, BATCHES_PER_WARP_SMALLER_THAN_128, WARP_ITER_2,C10_WARP_SIZE,1>;
        break;
    case 8: // 256
        kernel = &masked_softmax_warp_backward<input_t, output_t, acc_t, 1,WARP_ITER_3,C10_WARP_SIZE,1>;
        break;
    case 9: // 512
        kernel = &masked_softmax_warp_backward<input_t, output_t, acc_t, 1,WARP_ITER_4,C10_WARP_SIZE,1>;
        break;
    case 10: // 1024
        kernel = &masked_softmax_warp_backward<input_t, output_t, acc_t, 1,WARP_ITER_5,C10_WARP_SIZE,1>;
        break;
    default:
        return false;
    }

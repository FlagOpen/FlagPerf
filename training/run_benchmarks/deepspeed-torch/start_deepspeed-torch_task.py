...
def main():
    ...
    task_args.framework = "deepspeed-torch"

    task_log_dir = helper.init_flagperf_logger(START_LOGGER, task_args)
    helper.write_pid_file(task_args.log_dir, "start_deepspeed-torch_task.pid")
    ...
    exec_cmd = exec_cmd + " --deepspeed ds_config_tmp.json --data_dir " + task_args.data_dir

...
def main():
    ...
    operation = args.o
    log_path = args.l
    pid_fn = str('/tmp/hexaflake_monitor.pid')
    log_fn = str(log_path + '/hexaflake_monitor.log')
    err_fn = str(log_path + '/hexaflake_monitor.err')
    # result for gpu
    gpu_fn = str(log_path + '/hexaflake_monitor.log')
